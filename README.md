...
* **Astro:** Estructura de componentes ágil y optimizada.
* **Tailwind CSS:** Estilizado rápido y diseño *mobile-first*.
* **Vanilla JavaScript:** Lógica de apertura/cierre sin dependencias pesadas para asegurar el máximo rendimiento.
